...
```bash
cd /Users/vedangholay/Visual_studioJava/PingPong/ed_triage
python3 -m venv .venv
...
The root [`requirements.txt`](/Users/vedangholay/Visual_studioJava/PingPong/ed_triage/requirements.txt) forwards to the app dependency file so Streamlit Cloud installs the correct packages automatically.
